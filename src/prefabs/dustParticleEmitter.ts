...
// TODO Maybe make this file a class in order to have a unique emitter for other game objects too
...
export const emitDustParticles = (scene: Scene, x: number, y: number) => {
  ...
  emitter = scene.add.particles(0, 0, 'particle', {
    emitZone: { source: new Phaser.Geom.Circle(x, y, 10), type: 'random' } as Phaser.Types.GameObjects.Particles.EmitZoneData,
